...
data = dict(
    ...
    train=dict(
        ...
        datasets=[
            ...
            dict(
                type="CocoDataset",
                ann_file="data/Frames/annotations.json",
                img_prefix="data/Frames/",
                classes=classes,
                pipeline=train_pipeline,
            ),
        ],
    ...
    val=dict(
        img_prefix="data/images/", classes=classes, ann_file="data/annotation_val.json"
    ),
    test=dict(
        img_prefix="data/images/", classes=classes, ann_file="data/annotation_test.json"
    ),
